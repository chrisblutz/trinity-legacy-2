...
public class OperationProcedureAction implements ProcedureAction {
    ...
    public TyObject onAction(TyRuntime runtime, TyObject thisObj, TyObject... args) {
        ...
        double thisDouble = NativeConversion.asNumber(thisObj);
        double otherDouble = NativeConversion.asNumber(other);
        ...
        return NativeConversion.wrapNumber(performOperation(thisDouble, otherDouble));
    }
    ...
    private double performOperation(double thisDouble, double otherDouble) {
        ...
        switch (operation) {
            ...
            default:
                ...
                Errors.throwError(Errors.Classes.UNSUPPORTED_ERROR, "Operation " + operation + " not supported by " + NativeReferences.Classes.NUMERIC + ".");
                return 0;
        }
    }
