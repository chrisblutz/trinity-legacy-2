 ...
 */
public class TrinityMath {
    
    public static final MathType REAL_TYPES = new MathType(ClassRegistry.forName(TrinityNatives.Classes.INT, true), ClassRegistry.forName(TrinityNatives.Classes.LONG, true), ClassRegistry.forName(TrinityNatives.Classes.FLOAT, true));
